...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="middle-container" >
      Station ID starts from 2001 till _____.<br>Enter the station ID to view vehicles and its corresponding details that help in transporting the oil.<br><br>

      <form action ="utrans.php" method="post">
        <label for="">  Station ID : </label>
        <input type="text" name="ts" style="background: transparent;border: 1px solid black  ;border-radius: 10px; margin-left: 10px;  color: black;  height: 25px;width: 200px" required><br><br>
